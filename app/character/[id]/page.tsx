...
const CastDetailsPage = () => {
  ...
  const [character, setCharacter] = useState<CastDetailsResponse["data"]["character"] | null>(null);
  ...
  return (
    <>
      {loading ? <Loader /> :(<div className="flex flex-col items-center justify-center p-15.5 bg-[#191D29]">
        <Image
            ...
            <div className="flex flex-row items-center justify-between gap-3">
              ...
              >
                ...
                <p className="text-[#FFFFFF] text-[10px]">
                  Status{" "}
                  <span className="text-[20px] block">{character?.status}</span>
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[#FFFFFF] text-[10px]">
                  Gender{" "}
                  <span className="text-[20px] block">{character?.gender}</span>
                </p>
              </div>
